  ...
  (e.isValid = function (r) {
    ...
    (e.getPenaltyN1 = function (r) {
      ...
      for (let B = 0; B < n; B++) {
        ...
        for (let w = 0; w < n; w++) {
          let f = r.get(B, w);
          f === a ? c++ : (c >= 5 && (s += t.N1 + (c - 5)), (a = f), (c = 1)),
            (f = r.get(w, B)),
            f === l ? u++ : (u >= 5 && (s += t.N1 + (u - 5)), (l = f), (u = 1));
        }
    ...
    (e.getPenaltyN3 = function (r) {
      ...
      for (let a = 0; a < n; a++) {
        c = u = 0;
        for (let l = 0; l < n; l++)
          (c = ((c << 1) & 2047) | r.get(a, l)),
            l >= 10 && (c === 1488 || c === 93) && s++,
            (u = ((u << 1) & 2047) | r.get(l, a)),
            l >= 10 && (u === 1488 || u === 93) && s++;
      }
      return s * t.N3;
    }),
...
P.KANJI = new RegExp(z, "g");
P.BYTE_KANJI = new RegExp("[^A-Z0-9 $%*+\\-./:]+", "g");
P.BYTE = new RegExp(Ft, "g");
P.NUMERIC = new RegExp(Bt, "g");
P.ALPHANUMERIC = new RegExp(_t, "g");
const kt = new RegExp("^" + z + "$"),
  vt = new RegExp("^" + Bt + "$"),
  zt = new RegExp("^[A-Z0-9 $%*+\\-./:]+$");
...
(function (e) {
  const t = T,
    ...
    c = t.getBCHDigit(s);
  function u(w, f, m) {
    for (let y = 1; y <= 40; y++) if (f <= e.getCapacity(y, m, w)) return y;
  }
  function a(w, f) {
...
const tt = T,
  At = 1335,
  Vt = 21522,
  lt = tt.getBCHDigit(At);
pt.getEncodedBits = function (t, i) {
  const o = (t.bit << 3) | i;
  let r = o << 10;
  for (; tt.getBCHDigit(r) - lt >= 0; ) r ^= At << (tt.getBCHDigit(r) - lt);
  return ((o << 10) | r) ^ Vt;
};
var It = {};
const Ht = L;
function D(e) {
  (this.mode = Ht.NUMERIC), (this.data = e.toString());
}
...
D.prototype.write = function (t) {
  ...
  n > 0 &&
    ((o = this.data.substr(i)), (r = parseInt(o, 10)), t.put(r, n * 3 + 1));
};
var Kt = D;
const Jt = L,
  q = [
...
U.prototype.write = function (t) {
  ...
  for (i = 0; i + 2 <= this.data.length; i += 2) {
    let o = q.indexOf(this.data[i]) * 45;
    (o += q.indexOf(this.data[i + 1])), t.put(o, 11);
  }
  this.data.length % 2 && t.put(q.indexOf(this.data[i]), 6);
};
var Yt = U,
  Ot = function (t) {
    for (var i = [], o = t.length, r = 0; r < o; r++) {
      ...
      if (n >= 55296 && n <= 56319 && o > r + 1) {
        ...
        s >= 56320 &&
          s <= 57343 &&
          ((n = (n - 55296) * 1024 + s - 56320 + 65536), (r += 1));
      }
      if (n < 128) {
        i.push(n);
        continue;
...
(function (e) {
  ...
  function l(h, C, d) {
    ...
    let E;
    for (; (E = h.exec(d)) !== null; )
      g.push({ data: E[0], index: E.index, mode: C, length: E[0].length });
    return g;
  }
  function B(h) {
    const C = l(s.NUMERIC, t.NUMERIC, h),
      d = l(s.ALPHANUMERIC, t.ALPHANUMERIC, h);
    let g, E;
    return (
      c.isKanjiModeEnabled()
        ? ((g = l(s.BYTE, t.BYTE, h)), (E = l(s.KANJI, t.KANJI, h)))
        : ((g = l(s.BYTE_KANJI, t.BYTE, h)), (E = [])),
      C.concat(d, g, E)
        .sort(function (A, N) {
  ...
  function f(h) {
    return h.reduce(function (C, d) {
      ...
      return g && g.mode === d.mode
        ? ((C[C.length - 1].data += d.data), C)
        : (C.push(d), C);
    }, []);
  }
  function m(h) {
    ...
    for (let d = 0; d < h.length; d++) {
      ...
      switch (g.mode) {
        case t.NUMERIC:
          ...
          break;
        case t.ALPHANUMERIC:
          C.push([g, { data: g.data, mode: t.BYTE, length: g.length }]);
          break;
        case t.KANJI:
          C.push([g, { data: g.data, mode: t.BYTE, length: a(g.data) }]);
          break;
        case t.BYTE:
          C.push([{ data: g.data, mode: t.BYTE, length: a(g.data) }]);
      }
    }
    return C;
  }
    ...
    for (let p = 0; p < h.length; p++) {
      ...
      for (let b = 0; b < A.length; b++) {
        ...
        for (let Q = 0; Q < E.length; Q++) {
          const S = E[Q];
          d[S] && d[S].node.mode === M.mode
            ? ((g[S][k] =
                w(d[S].lastCount + M.length, M.mode) -
                w(d[S].lastCount, M.mode)),
              (d[S].lastCount += M.length))
            : (d[S] && (d[S].lastCount = M.length),
              (g[S][k] =
                w(M.length, M.mode) + 4 + t.getCharCountIndicator(M.mode, C)));
        }
      }
      E = N;
    }
    for (let p = 0; p < E.length; p++) g[E[p]].end = 0;
  ...
  (e.fromArray = function (C) {
    return C.reduce(function (d, g) {
      return (
        typeof g == "string"
          ? d.push(I(g, null))
          : g.data && d.push(I(g.data, g.mode)),
        d
      );
    }, []);
  }),
    (e.fromString = function (C, d) {
      const g = B(C, c.isKanjiModeEnabled()),
        E = m(g),
        p = y(E, d),
        A = u.find_path(p.map, "start", "end"),
        N = [];
      for (let b = 1; b < A.length - 1; b++) N.push(p.table[A[b]].node);
      return e.fromArray(f(N));
    }),
    (e.rawSplit = function (C) {
      return e.fromArray(B(C, c.isKanjiModeEnabled()));
    });
})(It);
const G = T,
  W = O,
...
function le(e, t, i) {
  ...
  i.forEach(function (u) {
    o.put(u.mode.bit, 4),
      o.put(u.getLength(), oe.getCharCountIndicator(u.mode, e)),
      u.write(o);
  });
  const r = G.getSymbolTotalCodewords(e),
    n = nt.getTotalCodewordsCount(e, t),
    s = (r - n) * 8;
  for (
...
function fe(e, t, i) {
  const o = G.getSymbolTotalCodewords(t),
    r = nt.getTotalCodewordsCount(t, i),
    n = o - r,
    s = nt.getBlocksCount(t, i),
    c = o % s,
    u = s - c,
    a = Math.floor(o / s),
    l = Math.floor(n / s),
  ...
  let g = 0,
    ...
    p;
  for (E = 0; E < h; E++)
    for (p = 0; p < s; p++) E < y[p].length && (d[g++] = y[p][E]);
  for (E = 0; E < w; E++) for (p = 0; p < s; p++) d[g++] = I[p][E];
  return d;
}
function ge(e, t, i, o) {
  let r;
  if (Array.isArray(e)) r = Z.fromArray(e);
  else if (typeof e == "string") {
    let a = t;
    if (!a) {
      const l = Z.rawSplit(e);
      a = Y.getBestVersionForData(l, i);
    }
    r = Z.fromString(e, a || 40);
...
`
  ...
  return (
    ...
    t >= 7 && ce(u, t),
    ae(u, s),
    isNaN(o) && (o = et.getBestMask(u, X.bind(null, u, i))),
    et.applyMask(o, u),
    X(u, i, o),
    {
      modules: u,
...
gt.create = function (t, i) {
  ...
  return (
    typeof i < "u" &&
      ((o = W.from(i.errorCorrectionLevel, W.M)),
      (r = Y.from(i.version)),
      (n = et.from(i.maskPattern)),
      i.toSJISFunc && G.setToSJISFunction(i.toSJISFunc)),
    ge(t, r, o, n)
  );
};
var Nt = {},
...
(function (e) {
  ...
  (e.render = function (n, s, c) {
    let u = c,
      a = s;
    typeof u > "u" && (!s || !s.getContext) && ((u = s), (s = void 0)),
      s || (a = o()),
      (u = t.getOptions(u));
    ...
    return (
      t.qrToImageData(w.data, n, u), i(B, a, l), B.putImageData(w, 0, 0), a
    );
  }),
  ...
  for (let c = 0; c < e.length; c++) {
    ...
    !u && !n && (n = !0),
      e[c]
        ? (s++,
          (c > 0 && u > 0 && e[c - 1]) ||
            ((o += n ? x("M", u + i, 0.5 + a + i) : x("m", r, 0)),
            (r = 0),
            (n = !1)),
          (u + 1 < t && e[c + 1]) || ((o += x("h", s)), (s = 0)))
        : r++;
  }
  return o;
}
Mt.render = function (t, i, o) {
  const r = de.getOptions(i),
    n = t.modules.size,
    s = t.modules.data,
    c = n + r.margin * 2,
    u = r.color.light.a
      ? "<path " +
        ft(r.color.light, "fill") +
        ' d="M0 0h' +
        c +
        "v" +
        c +
...
const we = St,
  ...
  Pt = Nt,
  me = Mt;
function ct(e, t, i, o, r) {
  const n = [].slice.call(arguments, 1),
    s = n.length,
    c = typeof n[s - 1] == "function";
  if (!c && !we()) throw new Error("Callback required as last argument");
  if (c) {
    ...
    s === 2
      ...
      : s === 3 &&
        (t.getContext && typeof r > "u"
          ? ((r = o), (o = void 0))
          : ((r = o), (o = i), (i = t), (t = void 0)));
  } else {
    if (s < 1) throw new Error("Too few arguments provided");
    return (
      s === 1
        ? ((i = t), (t = o = void 0))
        : s === 2 && !t.getContext && ((o = i), (i = t), (t = void 0)),
...
rt.create;
var ye = ct.bind(null, Pt.render);
ct.bind(null, Pt.renderToDataURL);
ct.bind(null, function (e, t, i) {
  return me.render(e, i);
});
function Ce({ canvas: e, text: t }) {
  ye(e, t, function (i) {
    if (i) {
      console.error(i);
      return;
...
window.CustomerApp = {
  ...window.CustomerApp,
  createQrCode: Ce,
  qrApiUrl: "/apps/custom-customer/app/api/customer/token",
};
